...
It enables rendering of the Obsidian plugin: [AutoCardLinkTitle](https://github.com/nekoshita/obsidian-auto-card-link) in Quartz.
...
When you run this command, files will be generated at:
